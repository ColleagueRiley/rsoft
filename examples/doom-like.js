...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'examples/doom-like.data';
      var REMOTE_PACKAGE_BASE = 'doom-like.data';
...
Module['FS_createPath']("/", "examples", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_examples/doom-like.data');

      };
      Module['addRunDependency']('datafile_examples/doom-like.data');
...
var ASM_CONSTS = {
 ...
 85800: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 85871: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 85928: () => { return window.mouseX || 0; },  
 85959: () => { return window.mouseY || 0; },  
 85990: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 86137: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86190: () => { return window.innerWidth; },  
 86220: () => { return window.innerHeight; },  
 86251: () => { Module.requestFullscreen(false, true); },  
 86290: () => { Module.exitFullscreen(false, true); },  
 86326: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
