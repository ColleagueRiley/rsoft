...
var ASM_CONSTS = {
  80340: () => { Module.useWebGL = true; GLImmediate.init(); },  
 ...
 81405: () => { return window.innerWidth; },  
 81435: () => { return window.innerHeight; },  
 81466: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 81523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); }
};
